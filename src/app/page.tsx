...
export default async function Home() {
  ...
  const services = [
    { title: content.services.service1Title, description: content.services.service1Desc, icon: serviceIcons[0] },
    { title: content.services.service2Title, description: content.services.service2Desc, icon: serviceIcons[1] },
    { title: content.services.service3Title, description: content.services.service3Desc, icon: serviceIcons[2] },
  ]

  const benefits = [
    { title: content.benefits.benefit1Title, description: content.benefits.benefit1Desc, icon: benefitIcons[0] },
    { title: content.benefits.benefit2Title, description: content.benefits.benefit2Desc, icon: benefitIcons[1] },
    { title: content.benefits.benefit3Title, description: content.benefits.benefit3Desc, icon: benefitIcons[2] },
    { title: content.benefits.benefit4Title, description: content.benefits.benefit4Desc, icon: benefitIcons[3] },
  ]
    ...
    <>
      ...
      <section className="relative min-h-[90vh] flex items-center overflow-hidden grain-texture">
        ...
        <div className="container relative z-10">
          <div className="max-w-3xl">
            ...
            <h1 className="mb-6">
              {content.hero.title}{' '}
              <span className="text-green-600 italic">{content.hero.titleHighlight}</span>
            </h1>
            ...
            <div className="mt-12 flex flex-wrap items-center gap-8 text-stone-500">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium">{content.hero.trust1}</span>
              </div>
              <div className="flex items-center gap-2">
                <svg className="w-5 h-5 text-green-600" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                </svg>
                <span className="text-sm font-medium">{content.hero.trust2}</span>
              </div>
              <div className="flex items-center gap-2">
                <svg className="w-5 h-5 text-green-600" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                </svg>
                <span className="text-sm font-medium">{content.hero.trust3}</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 bg-white relative">
        <div className="container">
          ...
          <div className="text-center max-w-2xl mx-auto mb-16">
            <span className="text-green-600 font-medium text-sm uppercase tracking-wider">{content.services.label}</span>
            <h2 className="mt-3 mb-4">{content.services.title}</h2>
            <p className="text-lg">
      ...
      <section className="py-24 bg-cream-dark relative overflow-hidden">
        ...
        <div className="container relative z-10">
          {/* Section Header */}
          <div className="text-center max-w-2xl mx-auto mb-16">
            <span className="text-green-600 font-medium text-sm uppercase tracking-wider">{content.benefits.label}</span>
            <h2 className="mt-3 mb-4">{content.benefits.title}</h2>
            <p className="text-lg">
      ...
      <section className="py-24 bg-green-700 relative overflow-hidden">
        ...
        <div className="container relative z-10 text-center">
          <h2 style={{ color: '#ffffff' }} className="mb-6">{content.cta.title}</h2>
          <p style={{ color: '#ffffff' }} className="text-xl max-w-2xl mx-auto mb-10">
          ...
          <p style={{ color: '#ffffff' }} className="mt-6 text-sm">
            {content.cta.note}
          </p>
        </div>
      </section>
