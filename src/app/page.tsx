...
const benefits = [
  {
    title: 'A Domicilio',
    description: 'Un fisioterapista qualificato viene direttamente a casa tua, senza stress da spostamenti.',
    icon: (
  ...
  },
  {
    ...
    description: 'Fisioterapisti laureati con anni di esperienza in riabilitazione.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    ...
    <>
      ...
      <section className="py-24 bg-green-700 relative overflow-hidden">
        ...
        <div className="container relative z-10 text-center">
          <h2 style={{ color: '#ffffff' }} className="mb-6">Pronto a stare meglio?</h2>
