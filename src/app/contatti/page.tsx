...
export const metadata: Metadata = {
  title: 'Contatti',
  description: 'Contatta Lorenzo Sicari fisioterapista a Roma. Telefono, WhatsApp, email. Servizio a domicilio in tutta Roma e provincia.',
}
    ...
    <>
      ...
      <section className="py-20 bg-green-50 relative overflow-hidden">
        ...
        <div className="container relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            <span className="text-green-600 font-medium text-sm uppercase tracking-wider">Contatti</span>
            <h1 className="mt-3 mb-6">Parliamo del tuo benessere</h1>
            <p className="text-xl text-stone-600 leading-relaxed">
              Hai domande o vuoi prenotare una visita? Contattami attraverso il canale che preferisci.
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <p className="text-lg text-stone-600 mb-8">
                Raggiungo i miei pazienti in tutta Roma e nei comuni limitrofi.
                Ecco alcune delle zone principali dove opero regolarmente:
              </p>
            ...
            {/* Orari */}
            <div>
              <span className="text-green-600 font-medium text-sm uppercase tracking-wider">Orari</span>
              <h2 className="mt-3 mb-6">Quando sono disponibile</h2>
              <p className="text-lg text-stone-600 mb-8">
                Offro massima flessibilità per adattarmi ai tuoi impegni.
                Prenota l&apos;orario più comodo per te.
              </p>
              ...
              <p className="mt-4 text-stone-500 text-sm">
                * Per urgenze o esigenze particolari, contattami e troveremo una soluzione.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-green-700">
        <div className="container text-center">
          <h2 style={{ color: '#ffffff' }} className="mb-4">Preferisci iniziare con il quiz?</h2>
